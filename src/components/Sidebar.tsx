      ...
      <div className={`relative flex items-center gap-2 px-3 py-4 ${collapsed ? "justify-center px-2" : "justify-between pl-4 pr-2"}`}>
        ...
        <button
          ...
          className={`rounded-sm p-1.5 text-muted-foreground transition-all hover:bg-sidebar-accent/60 ${
            collapsed
              ? "pointer-events-none absolute right-0 top-1/2 h-7 w-7 -translate-y-1/2 translate-x-1/2 rounded-full border border-sidebar-border bg-sidebar shadow-sm opacity-0 group-hover:pointer-events-auto group-hover:opacity-100"
              : ""
          }`}
